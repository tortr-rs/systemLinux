...
"x86_64\-linux-6\.12\.107\+deb13\-amd64" or
	die "Errno architecture (x86_64\-linux-6\.12\.107\+deb13\-amd64) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
