...
tie %Config, 'Config', {
    archlibexp => '/usr/lib64/perl5/5.44/x86_64-linux',
    ...
    osname => 'linux',
    osvers => '6.12.107+deb13-amd64',
    path_sep => ':',
    privlibexp => '/usr/lib64/perl5/5.44',
    scriptdir => '/usr/bin',
    sitearchexp => '/usr/local/lib64/perl5/5.44/x86_64-linux',
    sitelibexp => '/usr/local/lib64/perl5/5.44',
    so => 'so',
    useithreads => undef,
