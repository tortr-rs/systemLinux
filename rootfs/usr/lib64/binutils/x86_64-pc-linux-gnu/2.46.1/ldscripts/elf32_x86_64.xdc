...
ENTRY(_start)
SEARCH_DIR("/usr/x86_64-pc-linux-gnu/libx32"); SEARCH_DIR("/usr/lib64/binutils/x86_64-pc-linux-gnu/2.46.1x32"); SEARCH_DIR("/usr/local/libx32"); SEARCH_DIR("/libx32"); SEARCH_DIR("/usr/libx32"); SEARCH_DIR("/usr/x86_64-pc-linux-gnu/lib"); SEARCH_DIR("/usr/lib64/binutils/x86_64-pc-linux-gnu/2.46.1"); SEARCH_DIR("/usr/local/lib"); SEARCH_DIR("/lib"); SEARCH_DIR("/usr/lib");
SECTIONS
{
