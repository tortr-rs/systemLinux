...
#define DWARF_ALL_KNOWN_DW_AT \
  ...
  DWARF_ONE_KNOWN_DW_AT (language_name, DW_AT_language_name) \
  DWARF_ONE_KNOWN_DW_AT (language_version, DW_AT_language_version) \
...
#define DWARF_ALL_KNOWN_DW_LANG \
  DWARF_ONE_KNOWN_DW_LANG (Ada2005, DW_LANG_Ada2005) \
  DWARF_ONE_KNOWN_DW_LANG (Ada2012, DW_LANG_Ada2012) \
  DWARF_ONE_KNOWN_DW_LANG (Ada83, DW_LANG_Ada83) \
  DWARF_ONE_KNOWN_DW_LANG (Ada95, DW_LANG_Ada95) \
  DWARF_ONE_KNOWN_DW_LANG (Algol68, DW_LANG_Algol68) \
  DWARF_ONE_KNOWN_DW_LANG (Assembly, DW_LANG_Assembly) \
  DWARF_ONE_KNOWN_DW_LANG (BLISS, DW_LANG_BLISS) \
  DWARF_ONE_KNOWN_DW_LANG (C, DW_LANG_C) \
  DWARF_ONE_KNOWN_DW_LANG (C11, DW_LANG_C11) \
  DWARF_ONE_KNOWN_DW_LANG (C17, DW_LANG_C17) \
  DWARF_ONE_KNOWN_DW_LANG (C23, DW_LANG_C23) \
  DWARF_ONE_KNOWN_DW_LANG (C89, DW_LANG_C89) \
  DWARF_ONE_KNOWN_DW_LANG (C99, DW_LANG_C99) \
  DWARF_ONE_KNOWN_DW_LANG (CPP_for_OpenCL, DW_LANG_CPP_for_OpenCL) \
  ...
  DWARF_ONE_KNOWN_DW_LANG (C_plus_plus_17, DW_LANG_C_plus_plus_17) \
  DWARF_ONE_KNOWN_DW_LANG (C_plus_plus_20, DW_LANG_C_plus_plus_20) \
  DWARF_ONE_KNOWN_DW_LANG (C_plus_plus_23, DW_LANG_C_plus_plus_23) \
  DWARF_ONE_KNOWN_DW_LANG (C_sharp, DW_LANG_C_sharp) \
  DWARF_ONE_KNOWN_DW_LANG (Cobol74, DW_LANG_Cobol74) \
  DWARF_ONE_KNOWN_DW_LANG (Cobol85, DW_LANG_Cobol85) \
  DWARF_ONE_KNOWN_DW_LANG (Crystal, DW_LANG_Crystal) \
  DWARF_ONE_KNOWN_DW_LANG (D, DW_LANG_D) \
  DWARF_ONE_KNOWN_DW_LANG (Dylan, DW_LANG_Dylan) \
  DWARF_ONE_KNOWN_DW_LANG (Elixir, DW_LANG_Elixir) \
  DWARF_ONE_KNOWN_DW_LANG (Erlang, DW_LANG_Erlang) \
  DWARF_ONE_KNOWN_DW_LANG (Fortran03, DW_LANG_Fortran03) \
  DWARF_ONE_KNOWN_DW_LANG (Fortran08, DW_LANG_Fortran08) \
  DWARF_ONE_KNOWN_DW_LANG (Fortran18, DW_LANG_Fortran18) \
  DWARF_ONE_KNOWN_DW_LANG (Fortran23, DW_LANG_Fortran23) \
  ...
  DWARF_ONE_KNOWN_DW_LANG (GLSL, DW_LANG_GLSL) \
  DWARF_ONE_KNOWN_DW_LANG (GLSL_ES, DW_LANG_GLSL_ES) \
  DWARF_ONE_KNOWN_DW_LANG (Gleam, DW_LANG_Gleam) \
  DWARF_ONE_KNOWN_DW_LANG (Go, DW_LANG_Go) \
  DWARF_ONE_KNOWN_DW_LANG (HIP, DW_LANG_HIP) \
  DWARF_ONE_KNOWN_DW_LANG (HLSL, DW_LANG_HLSL) \
  DWARF_ONE_KNOWN_DW_LANG (Haskell, DW_LANG_Haskell) \
  DWARF_ONE_KNOWN_DW_LANG (Hylo, DW_LANG_Hylo) \
  DWARF_ONE_KNOWN_DW_LANG (Java, DW_LANG_Java) \
  DWARF_ONE_KNOWN_DW_LANG (Julia, DW_LANG_Julia) \
  DWARF_ONE_KNOWN_DW_LANG (Kotlin, DW_LANG_Kotlin) \
  DWARF_ONE_KNOWN_DW_LANG (Metal, DW_LANG_Metal) \
  ...
  DWARF_ONE_KNOWN_DW_LANG (Mojo, DW_LANG_Mojo) \
  DWARF_ONE_KNOWN_DW_LANG (Move, DW_LANG_Move) \
  DWARF_ONE_KNOWN_DW_LANG (Nim, DW_LANG_Nim) \
  ...
  DWARF_ONE_KNOWN_DW_LANG (Odin, DW_LANG_Odin) \
  DWARF_ONE_KNOWN_DW_LANG (OpenCL, DW_LANG_OpenCL) \
  DWARF_ONE_KNOWN_DW_LANG (OpenCL_CPP, DW_LANG_OpenCL_CPP) \
  DWARF_ONE_KNOWN_DW_LANG (P4, DW_LANG_P4) \
  ...
  DWARF_ONE_KNOWN_DW_LANG (Ruby, DW_LANG_Ruby) \
  DWARF_ONE_KNOWN_DW_LANG (Rust, DW_LANG_Rust) \
  DWARF_ONE_KNOWN_DW_LANG (SYCL, DW_LANG_SYCL) \
  DWARF_ONE_KNOWN_DW_LANG (Swift, DW_LANG_Swift) \
  DWARF_ONE_KNOWN_DW_LANG (UPC, DW_LANG_UPC) \
  DWARF_ONE_KNOWN_DW_LANG (V, DW_LANG_V) \
  DWARF_ONE_KNOWN_DW_LANG (Zig, DW_LANG_Zig) \
  /* End of DW_LANG_*.  */
...
#define DWARF_ALL_KNOWN_DW_LNAME \
  DWARF_ONE_KNOWN_DW_LNAME (Ada, DW_LNAME_Ada) \
  DWARF_ONE_KNOWN_DW_LNAME (Algol68, DW_LNAME_Algol68) \
  DWARF_ONE_KNOWN_DW_LNAME (Assembly, DW_LNAME_Assembly) \
  DWARF_ONE_KNOWN_DW_LNAME (BLISS, DW_LNAME_BLISS) \
  DWARF_ONE_KNOWN_DW_LNAME (C, DW_LNAME_C) \
  DWARF_ONE_KNOWN_DW_LNAME (CPP_for_OpenCL, DW_LNAME_CPP_for_OpenCL) \
  DWARF_ONE_KNOWN_DW_LNAME (C_plus_plus, DW_LNAME_C_plus_plus) \
  DWARF_ONE_KNOWN_DW_LNAME (C_sharp, DW_LNAME_C_sharp) \
  DWARF_ONE_KNOWN_DW_LNAME (Cobol, DW_LNAME_Cobol) \
  DWARF_ONE_KNOWN_DW_LNAME (Crystal, DW_LNAME_Crystal) \
  DWARF_ONE_KNOWN_DW_LNAME (D, DW_LNAME_D) \
  DWARF_ONE_KNOWN_DW_LNAME (Dylan, DW_LNAME_Dylan) \
  DWARF_ONE_KNOWN_DW_LNAME (Elixir, DW_LNAME_Elixir) \
  DWARF_ONE_KNOWN_DW_LNAME (Erlang, DW_LNAME_Erlang) \
  DWARF_ONE_KNOWN_DW_LNAME (Fortran, DW_LNAME_Fortran) \
  DWARF_ONE_KNOWN_DW_LNAME (GLSL, DW_LNAME_GLSL) \
  DWARF_ONE_KNOWN_DW_LNAME (GLSL_ES, DW_LNAME_GLSL_ES) \
  DWARF_ONE_KNOWN_DW_LNAME (Gleam, DW_LNAME_Gleam) \
  DWARF_ONE_KNOWN_DW_LNAME (Go, DW_LNAME_Go) \
  DWARF_ONE_KNOWN_DW_LNAME (HIP, DW_LNAME_HIP) \
  DWARF_ONE_KNOWN_DW_LNAME (HLSL, DW_LNAME_HLSL) \
  DWARF_ONE_KNOWN_DW_LNAME (Haskell, DW_LNAME_Haskell) \
  DWARF_ONE_KNOWN_DW_LNAME (Hylo, DW_LNAME_Hylo) \
  DWARF_ONE_KNOWN_DW_LNAME (Java, DW_LNAME_Java) \
  DWARF_ONE_KNOWN_DW_LNAME (Julia, DW_LNAME_Julia) \
  DWARF_ONE_KNOWN_DW_LNAME (Kotlin, DW_LNAME_Kotlin) \
  DWARF_ONE_KNOWN_DW_LNAME (Metal, DW_LNAME_Metal) \
  DWARF_ONE_KNOWN_DW_LNAME (Modula2, DW_LNAME_Modula2) \
  DWARF_ONE_KNOWN_DW_LNAME (Modula3, DW_LNAME_Modula3) \
  DWARF_ONE_KNOWN_DW_LNAME (Mojo, DW_LNAME_Mojo) \
  DWARF_ONE_KNOWN_DW_LNAME (Move, DW_LNAME_Move) \
  DWARF_ONE_KNOWN_DW_LNAME (Nim, DW_LNAME_Nim) \
  DWARF_ONE_KNOWN_DW_LNAME (OCaml, DW_LNAME_OCaml) \
  DWARF_ONE_KNOWN_DW_LNAME (ObjC, DW_LNAME_ObjC) \
  DWARF_ONE_KNOWN_DW_LNAME (ObjC_plus_plus, DW_LNAME_ObjC_plus_plus) \
  DWARF_ONE_KNOWN_DW_LNAME (Odin, DW_LNAME_Odin) \
  DWARF_ONE_KNOWN_DW_LNAME (OpenCL_C, DW_LNAME_OpenCL_C) \
  DWARF_ONE_KNOWN_DW_LNAME (OpenCL_CPP, DW_LNAME_OpenCL_CPP) \
  DWARF_ONE_KNOWN_DW_LNAME (P4, DW_LNAME_P4) \
  DWARF_ONE_KNOWN_DW_LNAME (PLI, DW_LNAME_PLI) \
  DWARF_ONE_KNOWN_DW_LNAME (Pascal, DW_LNAME_Pascal) \
  DWARF_ONE_KNOWN_DW_LNAME (Python, DW_LNAME_Python) \
  DWARF_ONE_KNOWN_DW_LNAME (RenderScript, DW_LNAME_RenderScript) \
  DWARF_ONE_KNOWN_DW_LNAME (Ruby, DW_LNAME_Ruby) \
  DWARF_ONE_KNOWN_DW_LNAME (Rust, DW_LNAME_Rust) \
  DWARF_ONE_KNOWN_DW_LNAME (SYCL, DW_LNAME_SYCL) \
  DWARF_ONE_KNOWN_DW_LNAME (Swift, DW_LNAME_Swift) \
  DWARF_ONE_KNOWN_DW_LNAME (UPC, DW_LNAME_UPC) \
  DWARF_ONE_KNOWN_DW_LNAME (V, DW_LNAME_V) \
  DWARF_ONE_KNOWN_DW_LNAME (Zig, DW_LNAME_Zig) \
  /* End of DW_LNAME_*.  */
...
#define DWARF_ALL_KNOWN_DW_SECT \
  DWARF_ONE_KNOWN_DW_SECT (ABBREV, DW_SECT_ABBREV) \
  DWARF_ONE_KNOWN_DW_SECT (INFO, DW_SECT_INFO) \
  DWARF_ONE_KNOWN_DW_SECT (LINE, DW_SECT_LINE) \
  DWARF_ONE_KNOWN_DW_SECT (LOCLISTS, DW_SECT_LOCLISTS) \
  DWARF_ONE_KNOWN_DW_SECT (MACRO, DW_SECT_MACRO) \
  DWARF_ONE_KNOWN_DW_SECT (RNGLISTS, DW_SECT_RNGLISTS) \
  DWARF_ONE_KNOWN_DW_SECT (STR_OFFSETS, DW_SECT_STR_OFFSETS) \
  DWARF_ONE_KNOWN_DW_SECT (TYPES, DW_SECT_TYPES) \
  /* End of DW_SECT_*.  */
