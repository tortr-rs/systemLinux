...
GType mm_gdbus_org_freedesktop_modem_manager1_get_type (void);
...
GType mm_gdbus_org_freedesktop_modem_manager1_proxy_get_type (void);
...
GType mm_gdbus_org_freedesktop_modem_manager1_skeleton_get_type (void);
